return {
	...
	account_finished = {
		...
		ru = "Поздравляем! Вы завершили Искупления для всей учетной записи на сложности %s.",
	},
	class_needs = {
