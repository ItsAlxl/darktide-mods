return {
	...
	account_needs = {
		en = "You need %s more on %s:\n%s"
	},
	account_finished = {
		en = "Congratulations! You have finished the penance for %s."
	},
	class_needs = {
	...
	difficulty_account_1 = {
		en = "Sedition"
	},
	difficulty_account_2 = {
		en = "Uprising"
	},
	difficulty_account_3 = {
		en = "Malice"
	},
	difficulty_account_4 = {
		en = "Heresy"
	},
	difficulty_account_5 = {
		en = "Damnation"
	},
}
